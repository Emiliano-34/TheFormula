...
router.get('/:idProducto', async (req, res) => {
  ...
  try {
    ...
    const result = await pool.request()
      ...
      .query('SELECT ID_RESENA as id, CALIFICACION as calificacion, TEXTO as texto FROM RESENAS WHERE ID_PRODUCTO = @idProducto');
...
router.post('/', async (req, res) => {
  const { idProducto, calificacion, texto } = req.body;
